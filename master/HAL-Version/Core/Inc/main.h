...
#define ENCODER_CH1_GPIO_Port GPIOE
#define ENCODER_CH2_Pin GPIO_PIN_11
#define ENCODER_CH2_GPIO_Port GPIOE
...
#define INPUT_RIGHT_Pin GPIO_PIN_12
#define INPUT_RIGHT_GPIO_Port GPIOD
#define INPUT_LEFT_Pin GPIO_PIN_13
