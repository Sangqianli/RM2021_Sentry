...
//			  An_Bullet_PPM.PID_PPM.measure= An_Bullet_PPM.position;
        ...
        case 6:
            ...
            if((Gimbal_yaw_PPM.position_get_last-Gimbal_yaw_PPM.position_get_now)>6000)
            {
                Gimbal_yaw_PPM.position_round++;
            }
            if((Gimbal_yaw_PPM.position_get_now-Gimbal_yaw_PPM.position_get_last)>6000)
            {
                Gimbal_yaw_PPM.position_round--;
            }
            Gimbal_yaw_PPM.PID_PPM.measure=(Gimbal_yaw_PPM.position_round*cnt_per_round+Gimbal_yaw_PPM.position_get_now-112);
        ...
        case 5:
            ...
            Gimbal_pitch_PPM.position_get_now=((Gimbal_pitch_PPM.position_get_now|RxMessage.Data[1])+121);
            if((Gimbal_pitch_PPM.position_get_last-Gimbal_pitch_PPM.position_get_now)>6000)
            {
                Gimbal_pitch_PPM.position_round++;
            }
            if((Gimbal_pitch_PPM.position_get_now-Gimbal_pitch_PPM.position_get_last)>6000)
            {
                Gimbal_pitch_PPM.position_round--;
            }

            Gimbal_pitch_PPM.PID_PPM.measure=-(Gimbal_pitch_PPM.position_round*cnt_per_round+Gimbal_pitch_PPM.position_get_now);
